...
<p align="center">
  ...
  ·
  <a href="https://github.com/shinteni/prompt-island/releases/download/v0.2.2/Vibelsland-Free-0.2.2-macos.zip">Download v0.2.2</a>
  ·
...
[Download Vibelsland Free v0.2.2](https://github.com/shinteni/prompt-island/releases/download/v0.2.2/Vibelsland-Free-0.2.2-macos.zip), unzip it, and move `>_ - island.app` to the Applications folder.
