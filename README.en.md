...
<p align="center">
  ...
  ·
  <a href="https://github.com/shinteni/prompt-island/releases/download/v0.3.4/Vibelsland-Free-0.3.4-macos.zip">Download v0.3.4</a>
  ·
...
[Download Vibelsland Free v0.3.4](https://github.com/shinteni/prompt-island/releases/download/v0.3.4/Vibelsland-Free-0.3.4-macos.zip), unzip it, and move `>_ - island.app` to the Applications folder.
