...
<p align="center">
  ...
  ·
  <a href="https://github.com/shinteni/prompt-island/releases/download/v0.3.3/Vibelsland-Free-0.3.3-macos.zip">Download v0.3.3</a>
  ·
...
[Download Vibelsland Free v0.3.3](https://github.com/shinteni/prompt-island/releases/download/v0.3.3/Vibelsland-Free-0.3.3-macos.zip), unzip it, and move `>_ - island.app` to the Applications folder.
