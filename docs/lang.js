  ...
  const copy = {
    zh: {
      ...
      strings: {
        ...
        "home.focus.eyebrow": "小而够用",
        "home.focus.title": "只提醒真正需要看的事。",
        "home.focus.item1.title": "运行中",
        "home.focus.item1.copy": "长任务不用反复切回终端。",
        "home.focus.item2.title": "等你确认",
        "home.focus.item2.copy": "审批请求留在视线范围内。",
        "home.focus.item3.title": "留在本机",
        "home.focus.item3.copy": "读取本地状态，不创建账号。",
        ...
        "home.trust.title": "本地读取状态，不发送遥测。",
        "home.trust.copy": "小工具就该安静：显示状态，少打扰，不把会话同步到远端。",
    ...
    en: {
      ...
      strings: {
        ...
        "home.spec.version.value": "v0.1.0",
        "home.focus.eyebrow": "Small by design",
        "home.focus.title": "Only the signals worth noticing.",
        "home.focus.item1.title": "Running",
        "home.focus.item1.copy": "Long tasks stay visible.",
        "home.focus.item2.title": "Needs approval",
        "home.focus.item2.copy": "Prompts stay in sight.",
        "home.focus.item3.title": "Stays local",
        "home.focus.item3.copy": "Reads local status. No account.",
        ...
        "home.trust.title": "Reads local status. No telemetry.",
        "home.trust.copy": "A small utility should stay quiet: show status, avoid noise, and keep sessions off remote servers.",
    ...
    ja: {
      ...
      strings: {
        ...
        "home.spec.version.value": "v0.1.0",
        "home.focus.eyebrow": "小さく設計",
        "home.focus.title": "見るべき状態だけを残します。",
        "home.focus.item1.title": "実行中",
        "home.focus.item1.copy": "長いタスクを見失いません。",
        "home.focus.item2.title": "承認待ち",
        "home.focus.item2.copy": "確認が必要なときだけ目に入ります。",
        "home.focus.item3.title": "Mac 内に保持",
        "home.focus.item3.copy": "ローカル状態を読み、アカウントは不要です。",
        ...
        "home.trust.title": "ローカル状態を読み、テレメトリは送りません。",
        "home.trust.copy": "小さなツールらしく、状態を見せ、余計に主張せず、セッションをリモートへ同期しません。",
