    ...
    zh: {
      ...
      meta: {
        ...
        download: {
          ...
          description: "下载 Vibelsland Free v0.3.1，查看 macOS 14+ 系统要求、首次打开说明、SHA-256 校验、源码和隐私边界。",
        ...
        "release-notes": {
          ...
          description: "Vibelsland Free 版本历史：v0.3.1 的下载、SHA-256 校验、主要功能、安装说明，以及当前仓库中的未发布改进。",
          ogTitle: "Vibelsland Free 版本历史",
          ogDescription: "查看 Vibelsland Free v0.3.1 的发布内容、下载包、校验文件、安装说明和当前仓库进展。"
        },
        404: {
      ...
      strings: {
        ...
        "advantages.cta.copy": "下载 v0.3.1 后，按安装与信任说明完成首次打开、SHA-256 校验和本地连接检查。",
        "advantages.cta.primary": "下载 macOS 版",
        "advantages.cta.secondary": "查看安装与信任",

        "download.hero.eyebrow": "下载",
        "download.hero.title": "下载 macOS 版",
        "download.hero.copy": "v0.3.1，macOS 14+，Universal（Apple Silicon & Intel）。",
        "download.hero.primary": "下载 v0.3.1",
        "download.hero.secondary": "查看安装与信任",
        "download.card.label": "当前版本",
        "download.card.version": "v0.3.1",
        ...
        "download.card.package.value": "Vibelsland-Free-0.3.1-macos.zip",
        ...
        "download.install.step2.copy": "运行 <code>cd ~/Downloads &amp;&amp; shasum -a 256 -c Vibelsland-Free-0.3.1-macos.zip.sha256</code>。",
    ...
    en: {
      ...
      meta: {
        ...
        download: {
          ...
          description: "Download Vibelsland Free v0.3.1 and review macOS 14+ requirements, first-launch notes, SHA-256 checksum, source code, and privacy boundaries.",
        ...
        "release-notes": {
          ...
          description: "Vibelsland Free release notes for v0.3.1, including downloads, SHA-256 verification, key features, install guidance, and current source updates.",
          ogTitle: "Vibelsland Free Release Notes",
          ogDescription: "Review Vibelsland Free v0.3.1 features, download assets, checksum file, install guidance, and current source progress."
        },
        404: {
      ...
      strings: {
        ...
        "advantages.cta.copy": "After downloading v0.3.1, follow install and trust guidance for first launch, SHA-256 verification, and local connection checks.",
        ...
        "download.hero.copy": "v0.3.1, macOS 14+, Universal (Apple Silicon & Intel).",
        "download.hero.primary": "Download v0.3.1",
        ...
        "download.install.step2.copy": "Run <code>cd ~/Downloads &amp;&amp; shasum -a 256 -c Vibelsland-Free-0.3.1-macos.zip.sha256</code>.",
    ...
    ja: {
      ...
      meta: {
        ...
        download: {
          ...
          description: "Vibelsland Free v0.3.1 をダウンロード。macOS 14+ 要件、初回起動、SHA-256、ソース、プライバシー境界を確認できます。",
        ...
        "release-notes": {
          ...
          description: "Vibelsland Free v0.3.1 のリリースノート。ダウンロード、SHA-256 確認、主要機能、インストール、現在のソース更新を確認できます。",
          ogTitle: "Vibelsland Free リリースノート",
          ogDescription: "Vibelsland Free v0.3.1 の機能、ダウンロード、チェックサム、インストール、現在のリポジトリ状況を確認できます。"
        },
        404: {
      ...
      strings: {
        ...
        "advantages.cta.copy": "v0.3.1 をダウンロードした後、インストールと信頼の手順で初回起動、SHA-256 確認、ローカル接続のヘルスチェックを確認できます。",
        ...
        "download.hero.copy": "v0.3.1、macOS 14+、Universal（Apple Silicon & Intel）。",
        "download.hero.primary": "v0.3.1 をダウンロード",
        ...
        "download.install.step2.copy": "<code>cd ~/Downloads &amp;&amp; shasum -a 256 -c Vibelsland-Free-0.3.1-macos.zip.sha256</code> を実行します。",
