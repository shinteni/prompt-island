  ...
  const copy = {
    zh: {
      ...
      strings: {
        ...
        "home.hero.eyebrow": "macOS 14+ · 本地优先",
        "home.hero.title": "Vibelsland Free",
        "home.hero.kicker": "把 AI 编程状态放在屏幕顶部。",
        "home.hero.copy": "显示 Claude Code、Codex CLI、Codex Desktop 的运行与审批。本地读取，无账号，无遥测。",
        "home.hero.primary": "下载 macOS 版",
        "home.hero.secondary": "查看隐私边界",
        "home.hero.status": "示例 · 工具运行中",
        ...
        "home.spec.data.value": "本地优先",
        "home.spec.version.label": "当前版本",
        "home.spec.version.value": "v0.1.0",
        "home.focus.eyebrow": "状态",
        "home.focus.title": "只看必要状态。",
        "home.focus.item1.title": "运行中",
        "home.focus.item1.copy": "长任务保持可见。",
        "home.focus.item2.title": "待确认",
        "home.focus.item2.copy": "不再错过审批请求。",
        "home.focus.item3.title": "本地",
        "home.focus.item3.copy": "无账号，无遥测。",
        ...
        "home.trust.eyebrow": "边界",
        "home.trust.title": "本地读取。无需遥测。",
        "home.trust.copy": "显示状态，少打扰，会话不上传。",
        "home.trust.read.label": "读取",
        "home.trust.read.value": "会话状态",
        "home.trust.write.label": "写入",
        "home.trust.write.value": "配置与日志",
        "home.trust.network.label": "网络",
        "home.trust.network.value": "核心离线可用",
        "home.cta.eyebrow": "下载",
        "home.cta.title": "下载 macOS 版。",
        "home.cta.copy": "v0.1.0 免费下载。源码和 SHA-256 校验公开。",
        ...
        "download.install.step1.copy": "获取 Vibelsland-Free-0.1.0-macos.zip。",
        "download.install.step2.title": "拖入 Applications",
        "download.install.step2.copy": "解压后移动 <code>&gt;_ - island.app</code>。",
        "download.install.step3.title": "Control 点按打开",
        "download.install.step3.copy": "首次启动按 macOS 提示确认。",
        "download.security.eyebrow": "签名与校验",
        "download.security.title": "校验下载。",
        "download.security.copy": "当前包使用 ad-hoc 签名。首次打开需要 Control 点按；下载后可用 SHA-256 文件校验。",
    ...
    en: {
      ...
      strings: {
        ...
        "shared.nav.download.short": "Download",
        ...
        "home.hero.eyebrow": "macOS 14+ · Local-first",
        "home.hero.title": "Vibelsland Free",
        "home.hero.kicker": "AI coding status, always in sight.",
        "home.hero.copy": "Shows Claude Code, Codex CLI, and Codex Desktop activity and approvals. Local only. No account. No telemetry.",
        "home.hero.primary": "Download for macOS",
        "home.hero.secondary": "View privacy boundaries",
        "home.hero.status": "Demo · Tool running",
        ...
        "home.spec.version.value": "v0.1.0",
        "home.focus.eyebrow": "Signal",
        "home.focus.title": "Only what matters.",
        "home.focus.item1.title": "Running",
        "home.focus.item1.copy": "Long tasks stay visible.",
        "home.focus.item2.title": "Approvals",
        "home.focus.item2.copy": "Approvals stay visible.",
        "home.focus.item3.title": "Local",
        "home.focus.item3.copy": "No account. No telemetry.",
        ...
        "home.trust.eyebrow": "Boundary",
        "home.trust.title": "Local reads. No telemetry.",
        "home.trust.copy": "Shows status without uploading sessions.",
        "home.trust.read.label": "Reads",
        "home.trust.read.value": "Session state",
        "home.trust.write.label": "Writes",
        "home.trust.write.value": "Config and logs",
        "home.trust.network.label": "Network",
        "home.trust.network.value": "Core works offline",
        "home.cta.eyebrow": "Download",
        "home.cta.title": "Download for macOS.",
        "home.cta.copy": "v0.1.0 is free. Source and SHA-256 verification are public.",
        ...
        "download.install.step1.copy": "Get Vibelsland-Free-0.1.0-macos.zip.",
        "download.install.step2.title": "Move to Applications",
        "download.install.step2.copy": "Unzip and move <code>&gt;_ - island.app</code>.",
        "download.install.step3.title": "Control-click Open",
        "download.install.step3.copy": "Confirm the first launch when macOS asks.",
        "download.security.eyebrow": "Signing and checksum",
        "download.security.title": "Verify the download.",
        "download.security.copy": "The current package is ad-hoc signed. First launch uses Control-click Open; the zip can be checked with the SHA-256 file.",
        "download.security.hash.label": "SHA-256",
    ...
    ja: {
      ...
      strings: {
        ...
        "home.hero.eyebrow": "macOS 14+ · ローカルファースト",
        "home.hero.title": "Vibelsland Free",
        "home.hero.kicker": "AI コーディングの状態を、画面上部に。",
        "home.hero.copy": "Claude Code、Codex CLI、Codex Desktop の実行状況と承認を表示。ローカルのみ。アカウント不要、テレメトリなし。",
        "home.hero.primary": "macOS 版をダウンロード",
        "home.hero.secondary": "プライバシー境界を見る",
        "home.hero.status": "デモ · ツール実行中",
        "home.spec.system.label": "システム",
        "home.spec.system.value": "macOS 14+",
        "home.spec.tools.label": "対応ツール",
        "home.spec.tools.value": "Claude Code / Codex CLI / Codex Desktop",
        "home.spec.data.label": "データ方針",
        "home.spec.data.value": "ローカル優先",
        "home.spec.version.label": "現在のバージョン",
        "home.spec.version.value": "v0.1.0",
        "home.focus.eyebrow": "状態",
        "home.focus.title": "必要な状態だけ。",
        "home.focus.item1.title": "実行中",
        "home.focus.item1.copy": "長いタスクを見失いません。",
        "home.focus.item2.title": "承認待ち",
        "home.focus.item2.copy": "承認を見逃しません。",
        "home.focus.item3.title": "ローカル",
        "home.focus.item3.copy": "アカウント不要。送信なし。",
        ...
        "home.trust.eyebrow": "境界",
        "home.trust.title": "ローカル読み取り。テレメトリなし。",
        "home.trust.copy": "状態だけを表示し、セッションはアップロードしません。",
        "home.trust.read.label": "読み取り",
        "home.trust.read.value": "セッション状態",
        "home.trust.write.label": "書き込み",
        "home.trust.write.value": "設定とログ",
        "home.trust.network.label": "ネットワーク",
        "home.trust.network.value": "主要機能はオフライン",
        "home.cta.eyebrow": "ダウンロード",
        "home.cta.title": "macOS 版をダウンロード。",
        "home.cta.copy": "v0.1.0 は無料です。ソースと SHA-256 確認を公開しています。",
        ...
        "download.install.step1.copy": "Vibelsland-Free-0.1.0-macos.zip を取得します。",
        "download.install.step2.title": "Applications へ移動",
        "download.install.step2.copy": "解凍して <code>&gt;_ - island.app</code> を移動します。",
        "download.install.step3.title": "Control クリックで開く",
        "download.install.step3.copy": "初回起動時は macOS の確認に従います。",
        "download.security.eyebrow": "署名とチェックサム",
        "download.security.title": "ダウンロードを確認。",
        "download.security.copy": "現在のパッケージは ad-hoc 署名です。初回起動は Control クリックで開き、zip は SHA-256 ファイルで確認できます。",
        "download.security.hash.label": "SHA-256",
