  ...
  const copy = {
    zh: {
      ...
      strings: {
        ...
        "home.hero.copy": "让 Claude Code、Codex CLI 和 Codex Desktop 的长任务、工具调用和审批请求一直可见，不必反复切回终端。",
        "home.hero.primary": "下载 macOS 版",
        "home.hero.secondary": "了解产品优势",
        "home.hero.assist.install": "安装与信任",
        "home.hero.assist.privacy": "本地数据边界",
        "home.hero.assist.faq": "常见问题",
        "home.hero.status": "示例 · 工具运行中",
        "home.demo.running": "运行中",
        "home.demo.approval": "待审批",
        "home.demo.idle": "空闲",
        ...
        "home.focus.item2.copy": "及时看到阻塞运行的审批请求。",
    ...
    en: {
      ...
      strings: {
        ...
        "home.hero.copy": "Keep Claude Code, Codex CLI, and Codex Desktop long tasks, tool calls, and approval requests visible without repeatedly switching back to a terminal.",
        "home.hero.primary": "Download for macOS",
        "home.hero.secondary": "Explore advantages",
        "home.hero.assist.install": "Install & trust",
        "home.hero.assist.privacy": "Local data boundary",
        "home.hero.assist.faq": "FAQ",
        "home.hero.status": "Demo · Tool running",
        "home.demo.running": "Running",
        "home.demo.approval": "Approval",
        "home.demo.idle": "Idle",
        ...
        "home.focus.item2.title": "Approval requests",
        "home.focus.item2.copy": "Catch approval requests before they block a run.",
        ...
        "home.cta.secondary": "Install & trust",
    ...
    ja: {
      ...
      strings: {
        ...
        "home.hero.copy": "Claude Code、Codex CLI、Codex Desktop の長いタスク、ツール実行、承認リクエストを見える場所に保ち、端末へ何度も戻らずに作業できます。",
        "home.hero.primary": "macOS 版をダウンロード",
        "home.hero.secondary": "製品の強みを見る",
        "home.hero.assist.install": "インストールと信頼",
        "home.hero.assist.privacy": "ローカルデータ境界",
        "home.hero.assist.faq": "FAQ",
        "home.hero.status": "デモ · ツール実行中",
        "home.demo.running": "実行中",
        "home.demo.approval": "承認待ち",
        "home.demo.idle": "待機中",
        ...
        "home.focus.item2.copy": "実行を止める承認リクエストに気づけます。",
