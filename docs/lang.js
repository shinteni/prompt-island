  ...
  const copy = {
    zh: {
      ...
      strings: {
        ...
        "home.step1.title": "1",
        "home.step1.copy": "下载 Vibelsland Free macOS 包并打开应用。",
        "home.step2.title": "2",
        "home.step2.copy": "完成校验与本机信任设置。",
        "home.step3.title": "3",
        "home.step3.copy": "开始让 AI 编程状态留在 macOS 顶部。",
    ...
    en: {
      ...
      strings: {
        ...
        "home.step1.title": "1",
        "home.step1.copy": "Download the Vibelsland Free macOS package and open the app.",
        "home.step2.title": "2",
        "home.step2.copy": "Verify the file and complete macOS trust settings.",
        "home.step3.title": "3",
        "home.step3.copy": "Keep AI coding status visible at the top of macOS.",
    ...
    ja: {
      ...
      strings: {
        ...
        "home.step1.title": "1",
        "home.step1.copy": "Vibelsland Free の macOS パッケージをダウンロードして開きます。",
        "home.step2.title": "2",
        "home.step2.copy": "ファイルを確認し、macOS の信頼設定を完了します。",
        "home.step3.title": "3",
