  ...
  const copy = {
    zh: {
      ...
      strings: {
        ...
        "download.install.step3.copy": "把应用拖入 Applications，Control 点按打开，再完成本地连接并查看设置页健康检查。",
    ...
    en: {
      ...
      strings: {
        ...
        "download.install.step3.copy": "Move the app to Applications, Control-click Open, then complete local connection setup and check Settings health.",
    ...
    ja: {
      ...
      strings: {
        ...
        "home.step1.title": "1",
        "home.step1.copy": "折りたたみ浮島：実行状態を上部に表示。",
        "home.step2.title": "2",
        "home.step2.copy": "展開浮島：ツール実行と進捗を確認。",
        "home.step3.title": "3",
        "home.step3.copy": "設定画面：ソース、通知、ローカル項目を管理。",
        ...
        "download.install.step3.copy": "Applications に移動し、Control クリックで開き、ローカル接続を設定して設定画面のヘルスチェックを確認します。",
