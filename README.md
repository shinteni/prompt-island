...
<p align="center">
  ...
  ·
  <a href="https://github.com/shinteni/prompt-island/releases/download/v0.3.6/Vibelsland-Free-0.3.6-macos.zip">下载 v0.3.6</a>
  ·
...
[下载 Vibelsland Free v0.3.6](https://github.com/shinteni/prompt-island/releases/download/v0.3.6/Vibelsland-Free-0.3.6-macos.zip)，解压后将 `>_ - island.app` 移到“应用程序”文件夹。
