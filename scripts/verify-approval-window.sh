...
MIN_WIDTH="${VIBELSLAND_APPROVAL_MIN_WIDTH:-380}"
MAX_WIDTH="${VIBELSLAND_APPROVAL_MAX_WIDTH:-560}"
MIN_HEIGHT="${VIBELSLAND_APPROVAL_MIN_HEIGHT:-90}"
MAX_HEIGHT="${VIBELSLAND_APPROVAL_MAX_HEIGHT:-200}"
