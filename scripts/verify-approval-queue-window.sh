...
# 队列卡片（2 行 = 140pt）比单审批卡（88pt）高 52pt（设计空间）：
# 0.8 缩放后此场景单审批窗口约 141pt，两个审批的队列窗口约 183pt，必须明显更高才算通过。
MIN_WIDTH="${VIBELSLAND_APPROVAL_QUEUE_MIN_WIDTH:-380}"
MAX_WIDTH="${VIBELSLAND_APPROVAL_QUEUE_MAX_WIDTH:-560}"
MIN_HEIGHT="${VIBELSLAND_APPROVAL_QUEUE_MIN_HEIGHT:-160}"
MAX_HEIGHT="${VIBELSLAND_APPROVAL_QUEUE_MAX_HEIGHT:-260}"
