...
- [ ] 确认下载包位于 `dist/Vibelsland-Free-0.3.0-macos.zip`。
...
- [ ] 公众下载信任链：在干净目录下载 zip 和 `.sha256`，运行 `cd ~/Downloads && shasum -a 256 -c Vibelsland-Free-0.3.0-macos.zip.sha256`，解压后拖入 Applications；若出现 Apple 无法验证提示，点“完成”，到“系统设置 → 隐私与安全性”点“仍要打开”，再安装或修复 hooks，并确认设置页健康检查正常。
