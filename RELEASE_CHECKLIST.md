...
- [ ] 公众下载信任链：在干净目录下载 zip 和 `.sha256`，运行 `cd ~/Downloads && shasum -a 256 -c Vibelsland-Free-0.1.0-macos.zip.sha256`，解压后拖入 Applications，Control 点按打开，安装或修复 hooks，并确认设置页健康检查正常。
